...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        help="Select CNN architecture [resnet34/resnet50/resnet101/alexnet/googlenet/vgg16/mobilenet_v2/resnet18]",
        default="resnet50",
    )
    parser.add_argument(
    ...
    tempo = start.elapsed_time(end)
    print('Tempo de dexecução em ms:')
    print(tempo)
