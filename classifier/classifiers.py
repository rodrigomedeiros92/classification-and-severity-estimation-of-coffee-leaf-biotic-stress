...
from net_models import shallow, resnet34, resnet50, resnet101, alexnet, googlenet, vgg16, mobilenet_v2, resnet18
...
class MultiTaskClf:
    ...
    def run_test(self):
        ...
        # Confusion matrix
        cm = confusion_matrix(y_true_dis, y_pred_dis)
        ...
        # Confusion matrix
        cm = confusion_matrix(y_true_sev, y_pred_sev)
