...
# ================================================
metric = 'val_acc'
path = '/home/stefanini/Documentos/UnB/CAM/Projeto4/lara2018/classifier/log/leaf_disease/'
...
plot(path + 'pesos_18.pkl', 'train_acc', '-b', 'Train')
plot(path + 'pesos_18.pkl', 'val_acc', '-r', 'Val')
